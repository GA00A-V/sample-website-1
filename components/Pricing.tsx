            ...
            <div className="container px-6 py-8 mx-auto">
                <div className="xl:items-center xl:-mx-8 xl:flex">
                    ...
                    <div className="flex-1 xl:mx-8">
                        <div
                            className="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 xl:mt-0">
                            <div className="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-gray-700">
                                <div className="p-6">
                                    ...
                                    <h2 className="mt-4 text-2xl font-medium text-gray-700 sm:text-4xl dark:text-gray-300">$3.00 <span
                                        className="text-base font-medium">/Month</span></h2>
                                    ...
                                    <button
                                        className="w-full px-4 py-2 mt-6 tracking-wide text-white capitalize transition-colors duration-200 transform bg-indigo-600 rounded-md hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500 focus:ring focus:ring-indigo-300 focus:ring-opacity-80">
                                        Start Now
                                    </button>
                                </div>
                                ...
                                <hr className="border-gray-200 dark:border-gray-700"/>
                                    ...
                                    <div className="p-6">
                                        <h1 className="text-lg font-medium text-gray-700 capitalize lg:text-xl dark:text-white">What’s
                                            included:</h1>

                                        <div className="mt-8 space-y-4">
                                            <div className="flex items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                     className="w-5 h-5 text-indigo-500" viewBox="0 0 20 20"
                                                     fill="currentColor">
                                                    <path fillRule="evenodd"
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <span
                                                    className="mx-4 text-gray-700 dark:text-gray-300">Chat support</span>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <span
                                                    className="mx-4 text-gray-700 dark:text-gray-300">Mobile app</span>
                                            </div>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <span
                                                    className="mx-4 text-gray-700 dark:text-gray-300">Unlimited users</span>
                                            </div>
                                        </div>
                                    </div>
                            </div>
                            ...
                            <div className="max-w-sm mx-auto border rounded-lg md:mx-4 dark:border-gray-700">
                                <div className="p-6">
                                    ...
                                    <h2 className="mt-4 text-2xl font-medium text-gray-700 sm:text-4xl dark:text-gray-300">$50.00 <span
                                        className="text-base font-medium">/life time</span></h2>
