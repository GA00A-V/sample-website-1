    ...
    return (
        ...
        <section id={'about'} className="bg-white dark:bg-gray-900">
            <div className="container px-6 py-10 mx-auto">
                <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Why
                    Learn from us</h1>

                <div className="pt-2">
                    <span className="inline-block w-40 h-1 rounded-full bg-indigo-500"></span>
                    <span className="inline-block w-3 h-1 ml-1 rounded-full bg-indigo-500"></span>
                    <span className="inline-block w-1 h-1 ml-1 rounded-full bg-indigo-500"></span>
                </div>
                ...
                <div className="mt-8 xl:mt-12 lg:flex lg:items-center">
                    <div className="w-full lg:w-1/2 grid grid-cols-1 gap-8 xl:gap-16 md:grid-cols-2">
                        <div className="space-y-3">
                            <span
                                className="inline-block p-3 text-indigo-500 bg-indigo-100 rounded-xl dark:text-white dark:bg-indigo-500">
                        ...
                        <div className="space-y-3">
                            ...
                            <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Hands-On Practice</h1>
                        ...
                        <div className="space-y-3">
                            ...
                            <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Complex topics made easy</h1>
